...
Implementação das 8 partes da atividade (Versão Demonstração)
"""
...
# Demonstração com número existente e não existente
numero_busca = vetor[3]  # Pegar um número que existe
print(f"Buscando número {numero_busca}...")
posicao = busca_sequencial(vetor, numero_busca)
print(f"Número {numero_busca} encontrado na posição {posicao}")

numero_inexistente = 999
posicao = busca_sequencial(vetor, numero_inexistente)
print(f"Número {numero_inexistente} não encontrado (posição: {posicao})")
...
print(f"6º número de Fibonacci: {fibonacci(6)} (esperado: 8)")
...
resultado_ordenado = em_ordem(arvore)
print(f"Travessia em ordem: {resultado_ordenado}")
...
removido = pilha.pop()
print(f"Após remover elemento {removido}: {pilha}")
...
removidos = []
for _ in range(3):
    removidos.append(fila.pop(0))
print(f"Removidos (FIFO): {removidos}")
print(f"Fila final: {fila}")

print("\nDiferença: Pilha = último a entrar, primeiro a sair (LIFO)")
print("          Fila = primeiro a entrar, primeiro a sair (FIFO)")
...
frutas_copy.sort()
print(f"Após ordenar: {frutas_copy}")

# .pop()
removido = frutas_copy.pop()
print(f"Após remover último elemento '{removido}': {frutas_copy}")

print("\nUtilidade dos métodos:")
print("- .count(): conta ocorrências de um elemento")
print("- .index(): encontra posição de um elemento")
print("- .append(): adiciona elemento no final")
print("- .sort(): ordena a lista")
print("- .pop(): remove e retorna último elemento")
...
print(f"Lista: {' -> '.join(lista_dupla.imprimir_frente())}")
...
print(f"Removido: {removido}")
print(f"Frente para trás: {' -> '.join(lista_dupla.imprimir_frente())}")
print(f"Trás para frente: {' -> '.join(lista_dupla.imprimir_tras())}")
...
valor1, valor2 = 15, 10
print(f"Comparando {valor1} e {valor2}:")
...
# Demonstração com notas fixas
print("\nDemo com 5 notas:")
notas = [8.5, 7.0, 9.2, 6.5, 7.8]
print(f"Notas: {notas}")
